    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('adresse_domiciliaire', textType::class, [
                'label' => ' ',
                'attr' => ['placeholder' => 'Adresse domiciliaire', 'class' => 'form-control'],
                'constraints' => [new NotBlank(), new Length(['min' => 3, 'max' => 255])]
            ])
            ...
            ->add('revenu_mensuel', integerType::class, [
                'label' => ' ',
                'attr' => ['placeholder' => 'Revenu mensuel', 'class' => 'form-control'],
            ...
            ->add('contact_personnel', telType::class, [
                'label' => ' ',
                'attr' => ['placeholder' => 'Téléphone personnel', 'class' => 'form-control'],
                'constraints' => [new NotBlank()]
            ])

            ->add('contact_fixe', telType::class, [
                'label' => ' ',
                'attr' => ['placeholder' => 'Téléphone fixe', 'class' => 'form-control'],
                'constraints' => [new NotBlank()]
            ])

            ->add('submit', SubmitType::class, [
                'label' => 'Obtenir mon prêt',
